	...
	\begin{columns}
		\begin{column}{.47\textwidth}
			...
			\begin{block}{\small{daily sunspot number}}
				\scalebox{.7}{\input{../sunSpots/img/daily/dataPlot.tex}}
				\scalebox{.7}{\input{../sunSpots/img/daily/profilePlot.tex}}
			\end{block}
		\end{column}
		\hfill
		\begin{column}{.47\textwidth}
			...
			\begin{block}{\small{monthly mean sunspot number}}
				\scalebox{.7}{\input{../sunSpots/img/monthly/dataPlot.tex}}
				\scalebox{.7}{\input{../sunSpots/img/monthly/profilePlot.tex}}
			\end{block}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{Sunspots}{DFA1}	
	...
	\begin{columns}
		\begin{column}{.47\textwidth}
			\centering
			\begin{block}{\small{daily sunspot number}}
			\scalebox{.7}{\input{../sunSpots/img/daily/DFAPlot.tex}}
			\end{block}
		\end{column}
		\hfill
		\begin{column}{.47\textwidth}
			\centering
			\begin{block}{\small{monthly mean sunspot number}}
			\scalebox{.7}{\input{../sunSpots/img/monthly/DFAPlot.tex}}
			\end{block}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}{Sunspots}{Profile fitted with polynomials of 7th order}
			\centering
			\scalebox{.7}{\input{../sunSpots/img/true/profilePlot.tex}}
\end{frame}

\begin{frame}{Sunspots}{DFA$k$ comparison}
		\centering
		\scalebox{.7}{\input{../sunSpots/img/true/DFAPlot.tex}}
\end{frame}
...
\begin{frame}{Sunspots}{Fourier-DFA}
	...
	\vfill
		\centering
		\scalebox{.5}{\input{../sunSpots/img/fourier/DFAPlot.tex}}
\end{frame}
